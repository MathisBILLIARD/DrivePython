...
urlpatterns = [
    ...
    path('upload_folder_in_folder/<int:folder_id>/', views.upload_folder_in_folder, name='upload_folder_in_folder'),
    path('create_folder/<str:folder_name>/', views.create_folder, name='create_folder'),
    path('create_folder_in_folder/<int:folder_id>/<str:folder_name>/', views.create_folder_in_folder, name='create_folder_in_folder'),
    path('display_folder/<int:folder_id>/', views.display_folder, name='display_folder'),
